...
| File | Size | SHA-256 |
|------|------|---------|
| `icebreaker_he_original.dump` | 524288 B | `5000be8cd361276b5a34122891052c6138ca0323995b23ed3eaeefd5f9035e86` |
| `icebreaker_he_option_bytes.dump` | 16 B | `d292558017cf9ca0a2e40e262a5c1daa4b305ccf084ce06128133d282f905115` |
...
```sh
dfu-util -a 0 -s 0x08000000:leave -D keyboards/icebreaker/he/original_firmware/icebreaker_he_original.dump
```
...
```sh
dfu-util -a 1 -s 0x1FFFC000 -D keyboards/icebreaker/he/original_firmware/icebreaker_he_option_bytes.dump
```
